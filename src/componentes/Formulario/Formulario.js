...
const Formulario = (props) => {
  ...
  // Para que se actulice la informacion que se ingresara en los inputs
  ...
  // para manejar el boton de crear
  ...
  return <section className='formulario'>
    <form onSubmit={manejarEnvio}>
      ...
      {/* este titulo, placeholder, etc.. seran propiedades */}
      ...
      <Campo titulo="Foto" placeholder="Ingresar enlace de la foto" required valor={foto} actualizarValor={actualizarFoto}/>
    ...
    <form onSubmit={manejarNuevoEquipo}>
      ...
      <Campo titulo="Nombre" placeholder="Ingresar titulo" required valor={titulo} actualizarValor={actualizarTitulo}/>
